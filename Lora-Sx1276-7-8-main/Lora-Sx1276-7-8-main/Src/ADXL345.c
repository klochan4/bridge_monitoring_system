...
//===================================
void ADXL345_readAccelAll(short *xyz)
//===================================	
{
...
//===============================================
void ADXL345_readAccel(short *x, short *y, short *z)
//===============================================	
{
...
void ADXL345_setBypassMode(void){
	byte _b;
...
void ADXL345_setStreamMode(void){
	byte _b;
	...
	#warning here
	//set one sample in FIFO to trigger watermark int
	_b &= ~16;
	_b &= ~8;
	_b &= ~4;
	_b &= ~2;
...
//=================================
void ADXL345_disableLowPower(void)
//=================================	
{
	byte _b;
	...
	ADXL345_readFrom(ADXL345_BW_RATE, 1, &_b);
	_b &= ~16;
	ADXL345_writeTo(ADXL345_BW_RATE, _b);
}

//=================================
void ADXL345_enableLowPower(void)
//=================================	
{
	byte _b;
...
//===============================================
int ADXL345_processInterfaceFunctionality(void)
//===============================================
{
	static int ret = 0;
