...
#define ADXL_CLK_Pin 						GPIO_PIN_13
#define ADXL_CLK_GPIO_Port 			GPIOB
...
#define ADXL_I2C_SCL_Pin 				GPIO_PIN_6
#define ADXL_I2C_SCL_GPIO_Port 	GPIOB
#define ADXL_I2C_SDA_Pin 				GPIO_PIN_7
#define ADXL_I2C_SDA_GPIO_Port 	GPIOB
#define TXD_DEBUG_Pin 					GPIO_PIN_9
#define TXD_DEBUG_GPIO_Port 		GPIOA
#define RXD_DEBUG_Pin 					GPIO_PIN_10
#define RXD_DEBUG_GPIO_Port 		GPIOA
...
#define ACCL_SPI_SCK_GPIO_CLK_ENABLE()    __HAL_RCC_GPIOB_CLK_ENABLE()
#define ACCL_SPI_SCK_GPIO_CLK_DISABLE()   __HAL_RCC_GPIOB_CLK_DISABLE()
...
extern  int ADXL345_processInterfaceFunctionality(void);
...
extern  void ADXL345_readAccelAll(short *xyz);
extern	void ADXL345_readAccel(short *x, short *y, short *z);
extern	void ADXL345_get_Gxyz(double *xyz);

//added by me
extern HAL_StatusTypeDef ADXL345_SPI_Init(void);
extern bool ADXL345_getInterruptSourceWithInt(byte);
...
extern void ADXL345_setDataRate(void);
extern 	int ADXL345_constrain(int x, int a, int b);
extern void ADXL345_print_byte(byte val);
extern void ADXL345_disableLowPower(void);
extern void ADXL345_setBypassMode(void);
extern void ADXL345_setStreamMode(void);
